...
class TestProfile(TestCase):
    ...
    def test_profile(self):
        ...
        self.assertRedirects(response, reverse('foodnet:dashboard:home'), status_code=302,
                             target_status_code=200, msg_prefix='')
...
class TestInvite(TestCase):
    ...
    def test_get(self):
        ...
        response = self.client.get(reverse('foodnet:membership:invite'))
        self.assertTemplateUsed(response, 'foodnet/membership/invite.html')
    ...
    def test_user_already_verified(self):
        ...
        response = self.client.post(reverse('foodnet:membership:invite'), data=data, follow=True)
    ...
    def test_send_invitation(self):
        ...
        self.assertRedirects(response, reverse('foodnet:dashboard:home'))
    ...
    def test_accept_invitation_flow(self):
        ...
        if settings.USE_RECAPTCHA:
            ...
            self.assertRedirects(response, reverse('foodnet:membership:new_member_set_password'),
                                 status_code=302,
        ...
        response = self.client.get(reverse('foodnet:dashboard:home'), follow=True)
        self.assertRedirects(
            response,
            reverse('profile'),
            status_code=302,
        ...
        self.assertRedirects(
            response,
            reverse('foodnet:dashboard:home'),
            status_code=302,
            target_status_code=200
        )
