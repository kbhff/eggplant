    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(max_digits=12, decimal_places=2, verbose_name='price', default=Decimal('0.0'))),
                ('stock', models.PositiveIntegerField(null=True, verbose_name='stock', default=1, help_text='Items in stock, leave blank if endless quantity available.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='description')),
                ('enabled', models.BooleanField(verbose_name='enabled', default=True)),
                ('tax', models.DecimalField(max_digits=5, decimal_places=4, verbose_name='tax', help_text="A factor, e.g. '0.25' adds 25% to value in order.")),
            ],
        ),
        migrations.AddField(
            model_name='product',
