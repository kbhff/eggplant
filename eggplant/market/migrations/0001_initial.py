    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='open', max_length=15, choices=[('open', 'open'), ('checked-out', 'checked-out')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basket', models.ForeignKey(related_name='items', to='market.Basket')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(default=Decimal('0.0'), max_digits=12, verbose_name='price', decimal_places=2)),
                ('stock', models.PositiveIntegerField(default=1, help_text='Items in stock, leave blank if endless quantity available.', null=True, verbose_name='stock')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='description')),
                ('enabled', models.BooleanField(default=True, verbose_name='enabled')),
                ('tax', models.DecimalField(help_text="A factor, e.g. '0.25' adds 25% to value in order.", verbose_name='tax', decimal_places=4, max_digits=5)),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ForeignKey(verbose_name='category', to='market.ProductCategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='tax',
            field=models.ForeignKey(verbose_name='tax', to='market.ProductTax'),
        ),
        migrations.AddField(
