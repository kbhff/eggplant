    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(verbose_name='price', default=Decimal('0.0'), max_digits=12, decimal_places=2)),
                ('stock', models.PositiveIntegerField(verbose_name='stock', default=1, null=True, help_text='Items in stock, leave blank if endless quantity available.')),
